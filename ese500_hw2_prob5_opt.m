...
% delta = 1
delta = 1.0;
nonli_sys_func1 = @(t,x) [0 1 + delta * sin(t) 0; -(1 + delta * sin(t)) 0 0; 0 0 0] * x + [1 0; 0 0; 0 1] * delta * [1 + delta - delta * sin(t); 1 + delta * sin(t)];
...
% delta = 0.5
delta = 0.5;
nonli_sys_func2 = @(t,x) [0 1 + delta * sin(t) 0; -(1 + delta * sin(t)) 0 0; 0 0 0] * x + [1 0; 0 0; 0 1] * delta * [1 + delta - delta * sin(t); 1 + delta * sin(t)];
...
% delta = 0.25
delta = 0.25;
nonli_sys_func3 = @(t,x) [0 1 + delta * sin(t) 0; -(1 + delta * sin(t)) 0 0; 0 0 0] * x + [1 0; 0 0; 0 1] * delta * [1 + delta - delta * sin(t); 1 + delta * sin(t)];
...
% delta = 1
delta = 1;
lin_sys_5f_func1 = @(t, x) A_5f * x + B_5f * ([1; 1] + delta * [1 - cos(t); sin(t)]) + [1; 0; 0];
[t_result31, x_result31] = ode45(@(t, x) lin_sys_5f_func1(t, x), t_span, x0);
y_result31 = C * x_result31';

% delta = 0.5
delta = 0.5;
lin_sys_5f_func2 = @(t, x) A_5f * x + B_5f * ([1; 1] + delta * [1 - cos(t); sin(t)]) + [1; 0; 0];
[t_result32, x_result32] = ode45(@(t, x) lin_sys_5f_func2(t, x), t_span, x0);
y_result32 = C * x_result32';

% delta = 0.25
delta = 0.25;
lin_sys_5f_func3 = @(t, x) A_5f * x + B_5f * ([1; 1] + delta * [1 - cos(t); sin(t)]) + [1; 0; 0];
